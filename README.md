...
Kiseki.Arbiter is licensed under the [GNU Affero General Public License v3.0](https://github.com/kiseki-lol/arbiter/blob/trunk/LICENSE.md). A copy of it has been included with Kiseki.Arbiter.
